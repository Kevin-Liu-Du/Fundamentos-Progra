...
AFRAME.registerComponent('model-viewer', {
    ...
    //fondo de escenario plano
    initBackground: function() {
        var backgroundEl = this.backgroundEl = document.querySelector('a-entity');
        backgroundEl.setAttribute('geometry', { primitive: 'sphere', radius: 100 });
        backgroundEl.setAttribute('material', {

            //esta propiedad tiene conexion con el file background-gradient.js
            //comentar la propiedad shader para quitar el background gradiant y el objeto queda solo
            shader: 'background-gradient',
            /*color arriba y abajo del fondo*/
            colorTop: '#d1f6f3',
            colorBottom: '#2786e1',
            //probar con front-back
            side: 'back'
